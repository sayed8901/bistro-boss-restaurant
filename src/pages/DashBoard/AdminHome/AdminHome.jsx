...
const AdminHome = () => {
  ...
  //   Additional info for statistics figure 2 (bar-chart)
  ...
  //   Additional info for statistics figure 3 (pie-chart)
  ...
  return (
    <div className="w-full px-8 min-h-full">
      ...
      {/* statistics figure 1 */}
      <div className="stats shadow my-8 -ms-4">
        <div className="stat">
