        ...
        <div className="card w-full lg:w-1/2 max-w-sm shadow-2xl bg-base-100">
          <form onSubmit={handleLogin} className="card-body">
            ...
            <div className="form-control">
              ...
              <input
                ref={captchaRef} type="text" name="captcha"
          ...
          <p className="text-center mb-4"><small>New Here? <Link className="hover:text-purple-500 font-bold" to={'/signup'}>Create an Account.</Link></small></p>
        </div>
      </div>
    </div>
    </>
